        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-8 flex-1">
          <div>
            ...
            <ul className="text-gray-700 space-y-2 text-sm">
              <li><Link href="#" className="hover:text-black transition">Buildmaster</Link></li>
              <li><Link href="#" className="hover:text-black transition">Paluto</Link></li>
              <li><Link href="#" className="hover:text-black transition">Brightline</Link></li>
              <li><Link href="#" className="hover:text-black transition">Watergate</Link></li>
              <li><Link href="#" className="hover:text-black transition">Sari-sari Manokan</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="text-gray-700 space-y-2 text-sm">
              <li><Link href="#" className="hover:text-black transition">Press Releases</Link></li>
          ...
          <div>
            ...
            <ul className="text-gray-700 space-y-2 text-sm">
              <li><Link href="#" className="hover:text-black transition">Open Positions</Link></li>
              <li><Link href="#" className="hover:text-black transition">Internships</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="text-gray-700 space-y-2 text-sm">
              <li><Link href="#" className="hover:text-black transition">Company</Link></li>
              <li><Link href="#" className="hover:text-black transition">Leadership</Link></li>
              <li><Link href="#" className="hover:text-black transition">Mission & Vision</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="text-gray-700 space-y-2 text-sm">
              ...
              <li><Link href="#" className="hover:text-black transition">Phone</Link></li>
