...
export default function EventsCatering({ sectionData, carouselImages }: EventsCateringProps) {
  ...
  return (
    <section className="w-full bg-qgc-gray-soft py-12 px-6">
      <div className="grid grid-cols-1 md:grid-cols-2 max-w-6xl mx-auto min-h-[450px] md:min-h-[500px] rounded-[2rem] overflow-hidden shadow-2xl border border-white/50 bg-white">
        ...
        <div className="relative h-[400px] md:h-auto overflow-hidden bg-gray-100">
          ...
          {/* Navigation Dots */}
          {images.length > 1 && (
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-2.5 z-10 bg-paluto-red/40 px-4 py-2.5 rounded-full border border-white/10">
