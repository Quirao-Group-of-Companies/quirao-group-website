...
const FEATURES = [
  {
    id: 1,
    image: '/images/logo/buildmaster/BM1.jpg',
    description:
      'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis',
  },
  {
    id: 2,
    image: '/images/logo/buildmaster/bm2.jpg',
    description:
      'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis',
  },
  {
    id: 3,
    image: '/images/logo/buildmaster/bm3.jpg',
    description:
      'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis',
  },
  {
    id: 4,
    image: '/images/logo/buildmaster/bm4.jpg',
    description:
      'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis',
  },
  {
    id: 5,
    image: '/images/logo/buildmaster/bm5.jpg',
    description:
      'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis',
  },
  {
    id: 6,
    image: '/images/logo/buildmaster/bm6.jpg',
    description:
      'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis',
  },
  {
    id: 7,
    image: '/images/logo/buildmaster/bm7.jpg',
    description:
      'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis',
  },
  {
    id: 8,
    image: '/images/logo/buildmaster/bm8.jpg',
    description:
      'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis',
  },
  {
    id: 9,
    image: '/images/logo/buildmaster/bm9.jpg',
    description:
      'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis',
  },
];
...
const PODCASTS = [
  {
    id: 1,
    image: '/images/buildmaster/podcasts/podcast-1.jpg',
    title: "WHAT DOES LOVE BUILD WHEN IT'S VISIBLE",
    guest: 'Erriz Lancota',
    host: 'Charu Mendez',
  },
  {
    id: 2,
    image: '/images/buildmaster/podcasts/podcast-2.jpg',
    title: 'WHY FOOD COMPLETES EVERY FILIPINO CHRISTMAS',
    guest: 'Cicij Jalandoni',
    host: 'Charu Mendez',
  },
  {
    id: 3,
    image: '/images/buildmaster/podcasts/podcast-3.jpg',
    title: 'WILL AI REPLACE FILIPINO WORKERS?',
    guest: 'Dr. Joel Garcera',
    host: 'Charu Mendez',
  },
  {
    id: 4,
    image: '/images/buildmaster/podcasts/podcast-4.jpg',
    title: "IT'S OKAY NOT TO LOOK PERFECT",
    guest: 'Jairo Jairo',
    host: 'Charu Mendez',
  },
];
...
export default function BuildMasterPage() {
  return (
    <main className="w-full min-h-screen bg-white">
      ...
      {/* 2. FEATURES */}
      <FeaturesCarousel features={FEATURES} ctaHref="https://buildmaster.ph" />
