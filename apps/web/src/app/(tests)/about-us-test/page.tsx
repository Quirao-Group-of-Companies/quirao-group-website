...
/**
 * Handles the structural difference between Strapi v4 (nested) and v5 (flat)
 */
type StrapiMedia =
  | StrapiImage
  ...
  return (
    <main className="w-full pb-20 space-y-24">
      ...
      <div className="container mx-auto px-4 space-y-24">
        ...
        {/* 4. QGC GROUP STRUCTURE */}
        {qgcStructure && (
          <section className="bg-gray-50 py-16 px-8 rounded-[3rem] text-center space-y-8">
            <div className="max-w-3xl mx-auto space-y-4">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900">{qgcStructure.title}</h2>
